...
let UserUseCases = class UserUseCases {
    constructor(userRepository, emailService, employeeRepository) {
...
exports.UserUseCases = UserUseCases = __decorate([
    ...
    __param(1, (0, inversify_1.inject)('EmailService')),
    __param(2, (0, inversify_1.inject)('EmployeeRepository')),
