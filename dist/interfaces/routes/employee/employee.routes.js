...
EmployeeRoutes.post('/newemp', authMiddleware_1.authenticate, asyncHandler((0, authMiddleware_1.authorize)(['employee:create'])), (0, validationMiddleware_1.validationMiddleware)(EmployeeDTO_1.CreateEmployeeDTO), employeeController.createEmployee.bind(employeeController));
