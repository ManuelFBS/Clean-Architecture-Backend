...
UserRoutes.post('/logout', authMiddleware_1.authenticate, userController.logout.bind(userController));
//~ Nueva ruta para verificar autenticación
UserRoutes.get('/auth/check', authMiddleware_1.authenticate, userController.checkAuth.bind(userController));
//~ Rutas autenticadas...
